...
<div class="probootstrap-page-wrapper">
  ...
  <nav class="navbar navbar-default probootstrap-navbar">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" style="background: url('<?php echo base_url('themes/_public/img/NC.png') ?>') no-repeat; background-size: 123px; height: 63px;" href="<?php echo base_url() ?>">CPSMI</a>
      </div>
  ...
  <?php if (in_array($this->router->fetch_class(), ['dashboard'])) : ?>
    ...
    <section class="probootstrap-section probootstrap-section-colored" style="background-color: orange">
      <div class="container">
        <div class="row">
